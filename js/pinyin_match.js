...
var n = {
  ...
  dia: "嗲",
  nou: "耨"
}, a = n, i = Object.keys(n), u = function() {
  var n = {};
  for (var i in a) for (var u = a[i], e = 0, o = u.length; o > e; e++) n[u[e]] = n[u[e]] ? n[u[e]] + " " + i : i;
  return n;
}(), e = {};
...
function g(n, a, u, e, o) {
  if (n !== a.length) for (var h = function(h) {
    var r = a.substring(n, h + 1), t = !1;
    if (i.some((function(n) {
      ...
      t = !0;
    } else -1 !== i.indexOf(r) && o[h + 1] && (u.push(r), t = !0);
    if (t) {
      var c = e.length;
      g(h + 1, a, u, e, o), e.length === c && (o[h + 1] = !1), u.pop();
    }
  }, r = n; a.length > r; r++) h(r); else e.push(u.join(" "));
}

function h(n) {
  var a = [];
  return o(n).forEach((function(n) {
    var i = n.split(" "), u = i.length - 1;
    i[u].indexOf(",") ? i[u].split(",").forEach((function(n) {
      i.splice(u, 1, n), a.push(JSON.parse(JSON.stringify(i)));
    })) : a.push(i);
  })), 0 !== a.length && a[0].length === n.length || a.push(n.split("")), e = function(n, a, i) {
...
function t(n, a, i) {
  for (var u = 0; n.length > u; u++) for (var e = 0; a.length > e; e++) {
    var o = a[e], g = o.length, h = g === i.length, t = !0, s = 0, c = 0, l = 0;
    if (n.length >= g) {
      for (; o.length > s; s++) if (0 === s && " " === n[u + s + c]) c += 1, s -= 1; else if (" " === n[u + s + l]) l += 1, s -= 1; else if (!r(n[u + s + l], o[s], !n[u + s + 1] || !o[s + 1], h)) {
        t = !1;
        break;
      }
      if (t) return [u + c, l + u + s - 1];
    }
  }
  return !1;
}
...
module.exports = {
  match: function(n, a) {
    if (!n || !a) return !1;
    n = n.toLowerCase(), a = a.replace(/\s+/g, "").toLowerCase();
    var i = n.indexOf(a);
    if (-1 !== i) return [i, i + a.length - 1];
    var o = t(n.split(""), [a.split("")], a);
    return o || t(function(n) {
      for (var a = [], i = 0, e = n.length; e > i; i++) {
        var o = n.charAt(i);
        a.push(u[o] || o);
      }
      return a;
